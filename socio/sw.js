...
const CACHE = 'medipaw-socio-v18'; // ⬅️ BUMPEAR EN CADA DEPLOY del /socio/ · v18: deploy con el fix de headers no-cache (firebase.json) — el update del SW ahora llega sin desregistrar (verificado v17→v18)
const SHELL = [
  './',
  './index.html',
  './manifest.json',
