...
(function (root, factory) {
  ...
  function cobertura(mascota, prestacion, monto, contexto) {
    ...
    // 3) carencia (desde el alta). FAIL-SAFE: sin alta verificable → NO cubre (motivo distinto). Reintegro 0 en carencia
    //    (decisión de negocio 25%-socio-vs-0 durante carencia → PARA LUCAS; hasta entonces reintegro 0).
